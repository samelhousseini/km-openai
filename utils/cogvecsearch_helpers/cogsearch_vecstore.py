...
class CogSearchVecStore:
    ...
    def __init__(self, api_key = COG_SEARCH_ADMIN_KEY, 
        ...
        if load_addtl_fields:
            self.addtl_fields += list(kb_doc.KB_Doc().get_fields() - ['text', 'text_en', VECTOR_FIELD_IN_REDIS, 'id'])
    ...
    def upload_documents(self, documents):
        ...
        for doc in documents:
            ...
            doc_dict[VECTOR_FIELD_IN_REDIS] = doc[VECTOR_FIELD_IN_REDIS]
    ...
    def search(self, query, search_type = 'vector', select=None, filter=None, verbose=False):
        ...
        query_dict = copy.deepcopy(utils.cogvecsearch_helpers.cs_json.search_dict_vector)
        query_dict['vector']['value'] = query_embedding
